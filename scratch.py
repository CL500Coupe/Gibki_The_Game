...
def kuba():
    ...
    if x_center12 + image_width12 > mouse[0] > x_center12 and y20 + 200 > mouse[1] > y20:

        display_surface.blit(bright_jakub, (x_center12, y20))
        if click[0] == 1:
            game_loop()
    else:
        display_surface.blit(player_jakub, (x_center12, y20))
...
def maciej():
    ...
    if x_center20 + image_width12 > mouse[0] > x_center20 and y20 + 200 > mouse[1] > y20:

        display_surface.blit(bright_maciej, (x_center20, y20))
        if click[0] == 1:
            game_loop()

        # pygame.mixer.Sound.play(maciej_sound,1)
        # pygame.mixer.Sound.set_volume(maciej_sound,0.3)
    else:
        display_surface.blit(player_maciej, (x_center20, y20))
...
def fabian():
    ...
    if 700 + image_width12 > mouse[0] > 700 and y20 + 200 > mouse[1] > y20:

        display_surface.blit(bright_fabian, (700, y20))
        if click[0] == 1:
            game_loop()

    else:
        display_surface.blit(player_fabian, (700, y20))
